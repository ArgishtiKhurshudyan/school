let User,Role,bcrypt,jwt,Joi;_10d‍.x([["register",()=>register],["login",()=>login]]);_10d‍.w("../models",[["User",["User"],function(v){User=v}],["Role",["Role"],function(v){Role=v}]]);_10d‍.w("bcryptjs",[["default",["bcrypt"],function(v){bcrypt=v}]]);_10d‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_10d‍.w("joi",[["default",["Joi"],function(v){Joi=v}]]);
