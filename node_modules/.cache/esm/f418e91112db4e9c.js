let User,Role,bcrypt,jwt,Joi;_12d‍.x([["register",()=>register],["login",()=>login]]);_12d‍.w("../models",[["User",["User"],function(v){User=v}],["Role",["Role"],function(v){Role=v}]]);_12d‍.w("bcryptjs",[["default",["bcrypt"],function(v){bcrypt=v}]]);_12d‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_12d‍.w("joi",[["default",["Joi"],function(v){Joi=v}]]);
