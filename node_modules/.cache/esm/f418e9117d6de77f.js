let User,Role,bcrypt,jwt,Joi;_7d6‍.x([["register",()=>register],["login",()=>login]]);_7d6‍.w("../models",[["User",["User"],function(v){User=v}],["Role",["Role"],function(v){Role=v}]]);_7d6‍.w("bcryptjs",[["default",["bcrypt"],function(v){bcrypt=v}]]);_7d6‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_7d6‍.w("joi",[["default",["Joi"],function(v){Joi=v}]]);
